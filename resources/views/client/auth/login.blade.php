...
@section('title', 'Đăng nhập Client')
...
<div class="login-container">
    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('client.login') }}" class="login-form" id="loginForm">
            @csrf
        ...
        <div class="social-buttons">
            <a href="{{ route('client.google.redirect') }}" class="btn-social btn-google">
        ...
        <div class="magic-link-section">
            ...
            <div class="magic-link-form" id="magicLinkForm" style="display: none;">
                <form method="POST" action="{{ route('client.magic-link.send') }}">
                    @csrf
                    <div class="form-group">
                        <input 
                            type="email" 
