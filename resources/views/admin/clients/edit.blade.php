            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="is_active" 
                            name="is_active" 
                            class="form-control">
                        <option value="1" {{ old('is_active', $client->is_active) == 1 ? 'selected' : '' }}>Hoạt động</option>
                        <option value="0" {{ old('is_active', $client->is_active) == 0 ? 'selected' : '' }}>Không hoạt động</option>
                    </select>
                </div>
            </div>
