...
<div class="dashboard-content">
    <div class="page-header">
        <h2 class="page-title">Sửa tài khoản admin</h2>
    ...
    <div class="content-card">
        <form action="{{ route('admin.accounts.update', $admin->id) }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="admin_login">Admin Login <span class="required">*</span></label>
                    <input type="text" 
                           id="admin_login" 
                           name="admin_login" 
                           value="{{ old('admin_login', $admin->admin_login) }}" 
                           class="form-control @error('admin_login') is-invalid @enderror"
                           required>
                    @error('admin_login')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
