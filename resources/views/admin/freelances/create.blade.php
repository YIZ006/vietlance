...
@section('title', 'Thêm freelancer')

@section('content')
<div class="dashboard-content">
    <div class="page-header">
        <h2 class="page-title">Thêm freelancer</h2>
    ...
    <div class="content-card">
        <form action="{{ route('admin.freelances.store') }}" method="POST">
            @csrf
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-success">
                    <i class="bi bi-check-circle"></i> Tạo freelancer
                </button>
                <a href="{{ route('admin.freelances.index') }}" class="btn btn-secondary">
